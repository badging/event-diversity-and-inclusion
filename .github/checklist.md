...
- [ ] **Session Accessibility** - Event attendees are able to access event platform after event
...
### Time Inclusion for Virtual Events and Playback
- [ ] **Pre-Recording** - Speakers have the ability to pre-record presentations.
- [ ] **Network Bandwidth Options** - Attendees are provided with more than one option for video quality
